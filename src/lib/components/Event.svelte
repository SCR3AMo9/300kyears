...
{#if containsTechTag(event)}
  ...
  <article
    class="event tech-collapsible"
    data-primary-type={getPrimaryTag(event)}
    class:expanded={techExpanded}
  >
...
<style>
  ...
  .event[data-primary-type="hammerfall"] {
    border-left-color: #2d2d2d;
  }
  .event[data-primary-type="collapse"] {
    border-left-color: #4a4a4a;
  }
  .event[data-primary-type="stress"] {
    border-left-color: #a67c52;
  }
  .event[data-primary-type="expansion"] {
    border-left-color: var(--color-expansion);
  }
  .event[data-primary-type="transition"] {
    border-left-color: #8a8a8a;
  }
  .event[data-primary-type="recovery"] {
    border-left-color: #a0a0a0;
  }
  .event[data-primary-type="parallel"] {
    border-left-color: #707070;
  }
  .event[data-primary-type="tech"] {
    border-left-color: #6b7b8a;
  }
  .event[data-primary-type="cognitive"] {
    border-left-color: #6a5a7a;
  }
  .event[data-primary-type="climate"] {
    border-left-color: #5a6878;
  }
  .event[data-primary-type="migration"] {
    border-left-color: #8a7a60;
  }
  .event[data-primary-type="external"] {
    border-left-color: #3a3235;
  }
  .event[data-primary-type="gain"] {
    border-left-color: #a08820;
  }
  .event[data-primary-type="lost"] {
    border-left-color: #3d3d3d;
  }
  /* Legacy type border colors */
  .event[data-primary-type="fragmentation"] {
    border-left-color: #5a5a5a;
  }
  .event[data-primary-type="tension"] {
    border-left-color: #9a8530;
  }
  .event[data-primary-type="adaptation"] {
    border-left-color: #5a6a78;
  }
  .event[data-primary-type="collision"] {
